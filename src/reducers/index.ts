...
import {GUIDELINE_ADD_ITEM, GUIDELINE_REMOVE_ITEM, ACTIONABLE_SELECT_CATEGORIES, ACTIONABLE_SHOW_INDICATOR, ACTIONABLE_HIDE_INDICATOR} from '../actions/guidelines';
