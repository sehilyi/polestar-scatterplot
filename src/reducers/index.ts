...
import {SPEC_FIELD_NESTED_PROP_CHANGE, SPEC_FIELD_PROP_CHANGE, SPEC_COLOR_SCALE_SPECIFIED, SPEC_COLOR_TRANSFORM_SPECIFIED, SPEC_TO_DENSITY_PLOT, SPEC_AGGREGATE_POINTS_BY_COLOR, SPEC_POINT_SIZE_SPECIFIED, SPEC_UNAGGREGATE_POINTS_BY_COLOR, SPEC_TO_REMOVE_DENSITY_PLOT} from '../actions/shelf/spec';
import {
...
export const USER_ACTIONS: ActionType[] = [
  ...
  SPEC_POINT_SIZE_SPECIFIED,
  SPEC_COLOR_TRANSFORM_SPECIFIED,
  SPEC_FIELD_AUTO_ADD,
  SPEC_FIELD_REMOVE,
  SPEC_FIELD_MOVE,
  ...
  // Shelf Actions for Guideline
  SPEC_TO_DENSITY_PLOT,
  SPEC_TO_REMOVE_DENSITY_PLOT,
  SPEC_AGGREGATE_POINTS_BY_COLOR,
  SPEC_UNAGGREGATE_POINTS_BY_COLOR,
  ...
  GUIDELINE_SET_USER_ACTION_TYPE,
  GUIDELINE_SHOW_RECT_INDICATOR,
