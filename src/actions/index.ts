...
export const ACTION_TYPE_INDEX: {[k in ActionType]: 1} = {
  ...
  GUIDELINE_TOGGLE_IGNORE_ITEM: 1,
  GUIDELINE_TOGGLE_ISEXPANDED: 1,
  GUIDELINE_SHOW_RECT_INDICATOR: 1,
  GUIDELINE_HIDE_INDICATOR: 1,

  ACTIONABLE_SELECT_CATEGORIES: 1,
  ACTIONABLE_ADJUST_POINT_SIZE: 1,
  ACTIONABLE_CHANGE_FILLED: 1,
  ACTIONABLE_ADJUST_POINT_OPACITY: 1,
